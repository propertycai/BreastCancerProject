 ...
 * 当前生存预测结果（用于保存功能）
 */
let currentSurvivalResult = null;
// ==================== 工具函数 ====================
/**
 * 显示加载状态
 */
 ...
 * 从表单获取诊断预测数据
 */
function getDiagnosisInputFromForm() {
    return {
        tumorThickness: parseFloat(document.getElementById('tumor-thickness').value),
        cellSizeUniformity: parseFloat(document.getElementById('cell-size-uniformity').value),
        cellShapeUniformity: parseFloat(document.getElementById('cell-shape-uniformity').value),
        marginalAdhesion: parseFloat(document.getElementById('marginal-adhesion').value),
        epithelialCellSize: parseFloat(document.getElementById('epithelial-cell-size').value),
        bareNuclei: parseFloat(document.getElementById('bare-nuclei').value),
        blandChromatin: parseFloat(document.getElementById('bland-chromatin').value),
        normalNucleoli: parseFloat(document.getElementById('normal-nucleoli').value),
        mitoses: parseFloat(document.getElementById('mitoses').value)
    };
}
/**
 * 从表单获取生存预测数据
 */
function getSurvivalInputFromForm() {
    return {
        age: parseInt(document.getElementById('age').value),
        race: document.getElementById('race').value,
        maritalStatus: document.getElementById('marital-status').value,
        familyIncome: parseFloat(document.getElementById('family-income').value),
        residence: document.getElementById('residence').value,
        ajccStage: document.getElementById('ajcc-stage').value,
        tStage: document.getElementById('t-stage').value,
        nStage: document.getElementById('n-stage').value,
        mStage: document.getElementById('m-stage').value,
...
// 导出供其他模块使用（可选）
export { callDiagnosisAPI, callSurvivalAPI, saveRecordAPI };
